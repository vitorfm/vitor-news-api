...
class News(models.Model):
    ...
    pro_only = models.BooleanField(
        default=False, help_text="Define se o conteúdo é exclusivo para usuários PRO"
    )
    scheduled_pub_date = models.DateTimeField(
        null=True, blank=True, help_text="Data agendada para publicação automática."
    )
